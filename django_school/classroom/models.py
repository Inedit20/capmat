...
class Laboratoire(models.Model):
    name = models.CharField(max_length=100)
    logo = models.ImageField(upload_to='media/', default='default.jpg', verbose_name=u"Logo ", null=True)
    localisation = models.CharField(max_length=270, null=True, blank=True, verbose_name=u"Localsation du laboratoire : ")
...
class Universite(models.Model):
    name = models.CharField(max_length=100)
    adresse_universite= models.CharField(max_length=100, blank=True, null=True )
    logo = models.ImageField(upload_to='media/', default='default.jpg', verbose_name=u"Logo ", null=True)
    localisation = models.CharField(max_length=270, null=True, blank=True, verbose_name=u"Localsation de l'université : ")
    contact = PhoneField(help_text="contact", null =True, blank=True)
...
class Profile(models.Model):
    ...
    numero_telephone = models.CharField(max_length=100000,null=True,verbose_name=u"Contact ", blank=True)
   
    autre_fonction =  models.CharField(max_length=270,verbose_name= u"autre : ",  null=True, blank=True) 
    laboratoire = models.CharField(max_length=170, verbose_name=u"Composante ", null=True, blank=True)
    autre_labo= models.CharField(max_length=100,verbose_name=u"autre : ",   null=True, blank=True)
    universite = models.CharField(max_length=170, verbose_name=u"Université ", null=True,blank=True)
...
class Quiz(models.Model):
    ...
    description_projet =RichTextField(blank=True, null=True, help_text=" Résumé / objectifs ", verbose_name= u" Description du projet ")
    type_evt = models.ManyToManyField(TypeCapteur,  verbose_name=u"Type de l'événement à détecter  ", related_name='type_projets')
    domaine = models.ManyToManyField(Domaine, verbose_name= u"Domaine d'application du projet  ", related_name='domaines_projet')
    ...
    chaine = models.ManyToManyField(Chaine, verbose_name= u"Chaine de connaissances ", related_name='chaines')
...
class Student(models.Model):
    ...
    chaine= models.ManyToManyField(Chaine, verbose_name=u"Chaine Logistique", help_text=u"Chaine de connaissances", blank=True)
    image = models.ImageField(upload_to='media/', default='default.jpg', verbose_name=u"Photo de profil ", null=True, blank=True)
    nom = models.CharField(max_length=270,verbose_name= u"Nom  ",  null=True, blank=True)
    prenom = models.CharField(max_length=270,verbose_name= u"Prénom  ",  null=True, blank=True)
    presentation = RichTextField(blank=True, null=True, verbose_name= u" Présentation ")
    mots_cles = models.CharField(max_length=270,verbose_name= u"Mots clés  ",  null=True, blank=True)
    domaine = models.ManyToManyField(Domaine, verbose_name= u"Domaines d'applications  ",  related_name='domaines_expert', blank=True)
    adresse_email = models.EmailField(max_length=100,verbose_name=u"Adresse email  ",   null=True, blank=True)
    numero_telephone = models.CharField(max_length=100000,null=True,verbose_name=u"Contact ", blank=True)
    ...
    autre_labo= models.CharField(max_length=100,verbose_name=u"autre : ",   null=True, blank=True)
    universite = models.CharField(max_length=170, verbose_name=u"Université ", null=True,blank=True)
    autre_univ= models.CharField(max_length=100,verbose_name=u"autre : ",   null=True, blank=True)
    link= models.URLField(blank=True, max_length=2000, verbose_name= u"Lien vers votre page officielle ou (LinkedIn, ResearchGate, etc.)")
...
class Capteur(models.Model):
    ...
    type_evt = models.ManyToManyField(TypeCapteur, verbose_name= u"Type d'événements à détecter  ", related_name='type_capteurs')
...
class Collaboration_connaissances(models.Model):
    LOW = 0
    NORMAL = 1
    HIGH = 2
    STATUS_CHOICES = (
    ...
    (NORMAL, 'Confirmée'),
    (HIGH, 'Refusée'), )
    porteur = models.ForeignKey(User, on_delete=models.CASCADE,  related_name='connaissance_porteur')
    expert = models.ForeignKey(User, on_delete=models.CASCADE,  related_name='connaissance_expert')
    projet = models.ForeignKey(Quiz, on_delete=models.CASCADE,  related_name='connaissance_projet')
    statut = models.IntegerField(default=NORMAL, choices=STATUS_CHOICES)
    created_at = models.DateTimeField(auto_now_add=True, null= True)
